...
ApplicationWindow {
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        MouseArea { id: goTimerArea; anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: { taskDrawer.close(); pageLoader.sourceComponent = timerComponent } }
                    }
        ...
        Row {
            ...
            Text {
                ...
                MouseArea {
                    ...
                    onClicked: pageLoader.sourceComponent = inputTugasComponent
                }
            }
        }
    }
    ...
    Component {
        id: loginComponent
        Login {
            onLoginSuccess: pageLoader.sourceComponent = mainComponent
        }
    }
    Component {
        id: mainComponent
